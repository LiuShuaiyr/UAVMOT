...
if __name__ == '__main__':
    ...
    if opt.val_visdrone:
        seqs_str = '''uav0000086_00000_v
                      ...
                      uav0000339_00001_v
                      '''
        data_root = os.path.join(opt.data_dir, 'visdrone/val/sequences')
    ...
    if opt.test_visdrone:
        seqs_str = '''uav0000009_03358_v
                      ...
                      uav0000370_00001_v
                      '''
        data_root = os.path.join(opt.data_dir, 'visdrone/test/sequences')
    seqs = [seq.strip() for seq in seqs_str.split()]
    ...
    main(opt,
         data_root=data_root,
         seqs=seqs,
         exp_name='MCMOT_exp9_1108_train_baseline_view_visdrone_results_val_dla',
         # exp_name='exp',
         show_image=False,
         save_images=False,
         save_videos=False)
