...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('--arch',
                                 default='dlamot-exp2_34',
                                 help='model architecture. Currently tested'
                                      'resdcn_18 |resdcn_34 | resdcn_50 | resfpndcn_34 |'
                                      'dla_34 | dlamot_34 |dlamot-exp1_34| dlamot-exp2_34')
        ...
        self.parser.add_argument(
            '--val_visdrone', default=True, help='val visdrone')
        self.parser.add_argument(
        ...
        self.parser.add_argument('--data_dir',
                                 type=str,
                                 default='/media/ls/FA5ECF148688E396/DataSet')
