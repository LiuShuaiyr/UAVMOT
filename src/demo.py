...
def run_demo(opt):
    ...
    try:
        if opt.input_mode == 'video':
            ...
            output_dir = '/home/ls/code/Tracking/MCMOT/results/tmp'
...
def test_single(img_path, dev):
    ...
    model_path = '/home/ls/code/Tracking/MCMOT/exp/mot/default/model_30.pth'
...
if __name__ == '__main__':
    opt = opts().init()
    opt.input_mode == 'image_dir'
    run_demo(opt)

    # test_single(img_path='/media/ls/FA5ECF148688E396/DataSet/visdrone/val/sequences/uav0000137_00458_v', dev=torch.device('cpu'))
