...
if __name__ == '__main__':
    # gen_track_dataset(src_root='/media/ls/FA5ECF148688E396/DataSet/visdrone/val',
    #                   dst_root='/media/ls/FA5ECF148688E396/DataSet/visdrone_fmot/val',
    #                   viz_root=None)
    gen_dot_train_file(data_root = '/media/ls/FA5ECF148688E396/DataSet/', rel_path='visdrone_fmot/train/images',
                      out_root='/home/ls/code/Tracking/MCMOT_exp/src/data', f_name='visdrone.train')
